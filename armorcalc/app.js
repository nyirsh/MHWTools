...
(function() {
    ...
    function Cb(a) {
        ...
        return b +
            ...
            + '<hr><div style="margin-bottom: 5px;" translation-section="armorcalc" translation-key="deco_export_text">' + _gts('armorcalc', 'deco_export_text') + '</div><button style="margin-bottom: 5px;" onclick="exportDecos()"><span class="oi oi-cloud-download" title="data-cloud-download" aria-hidden="true"></span>&nbsp;<span translation-key="armorcalc" translation-key="export">' + _gts('armorcalc', 'export') + '</span></button></div><textarea id="decoimportexport" style="width:100%"></textarea><div><button onclick="importDecos()"><span class="oi oi-cloud-upload" title="data-cloud-upload" aria-hidden="true"></span>&nbsp;<span translation-key="armorcalc" translation-key="import">' + _gts('armorcalc', 'import') + '</span></button></div></div>'
    }
