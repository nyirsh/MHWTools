...
(function() {
    ...
    function GenerateEleResSelect(id) {
        var gershtml = '<span translation-section="armorcalc" translation-key="' + id + '">' + _gts('armorcalc', id ) + ' <select id="' + toEncodedString(id) + '" class="filtersInput"><option value="-100">---</option>';
        for (var b = -25; b < 26; b++)
